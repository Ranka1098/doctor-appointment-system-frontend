    ...
    try {
      const res = await axios.post(
        "http://localhost:3000/apply-doctor",
        {
          ...
          experince: information.experince,
          feesPerConsultation: information.feesPerConsultation,
          timing: information.timing,
          userId: user._id, // user id ko bhi bheja ja rah hai
        },
        {
          headers: {
      ...
      if (res.status === 201) {
        alert("dcotor applied successfully");
        setInformation({
          firstName: "",
          lastName: "",
          phone: "",
